...
def annotate_splice_site_classification_include_last_exon_pos(
    ...
    if not any(
        ...
        var_type.value == VARTYPE.SPLICE_REGION_VARIANT.value
...
def get_annotate_splice_site_classification_include_last_exon_pos(
